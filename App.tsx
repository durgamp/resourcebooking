...
import { ViewType, Reactor, Booking, Downtime } from './types';
...
const App: React.FC = () => {
  ...
  const submitNewBooking = useCallback((newBooking: Booking) => {
    console.info(`[Audit] New Booking Committed: ${newBooking.id} by ${newBooking.requestedByEmail}`);
